 ...
 * and its gating route under that root — {@link PopulationRef}'s sibling, for the same
 * reason and built the same way.
 * <p>
 ...
 * {@code AnalysisSession.resolveDenominator} can re-find the live {@link Branch} the ref
 ...
 * {@link PopulationRef}'s javadoc explains — {@code rootIndex} is the one field that
